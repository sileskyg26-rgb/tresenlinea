...
from Model.Cell import Cell  # noqa: F401
...
def print_title():
    print("=" * 40)
    print("      TIC-TAC-TOE  (3 en raya) + QUANTUM")
    print("=" * 40)
...
def print_menu():
    ...
    print("3. Bot vs Bot")
    print("4. Quantum Bot vs Quantum Bot")
    print("5. Quantum Bot vs Bot")
    print("6. Exit")
    print("-" * 40)
...
# Player / game setup
# --------------------------------------------------------------------------- #
def build_players(mode: str, human_goes_first: bool = True, quantum_goes_first: bool = True):
    """
    mode: "hh", "hb", "bb", "qq", "qb"
    ...
    if mode == "qb":
        qbot = Player("Quantum Bot", symbol_x, QuantumBotStrategy(difficulty=1.0))
        bot = Player("Bot", symbol_o, BotStrategy())
        return [qbot, bot] if quantum_goes_first else [bot, qbot]
...
def quantum_vs_quantum():
    players = build_players("qq")
    print("\nStarting Quantum Bot vs Quantum Bot match...")
    play(players, bot_vs_bot=True)
...
def quantum_vs_bot():
    ...
    print("2. Normal Bot")
    choice = prompt_int("Choose (1-2): ", [1, 2])
    quantum_first = choice == 1
    players = build_players("qb", quantum_goes_first=quantum_first)
    print("\nStarting Quantum Bot vs Bot match...")
    play(players, bot_vs_bot=True)
...
def main():
    while True:
        ...
        print_title()
        print_menu()
        choice = prompt_int("Select an option (1-6): ", [1, 2, 3, 4, 5, 6])
